...
app.post('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ad = yield prisma.ad.create({
        data: {
            ...
            hourStart: (0, convert_hours_string_to_minutes_1.converteHourStringToMinutes)(body.hourStart),
            hourEnd: (0, convert_hours_string_to_minutes_1.converteHourStringToMinutes)(body.hourEnd),
...
app.get('/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return response.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_to_hour_string_1.converteMinutesToHourString)(ad.hourStart), hourEnd: (0, convert_minutes_to_hour_string_1.converteMinutesToHourString)(ad.hourEnd) });
    }));
}));
